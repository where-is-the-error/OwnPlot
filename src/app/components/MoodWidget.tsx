  ...
  return (
    <PlotCard title="Real-time Mood">
      <div className="flex flex-col items-center justify-center gap-4">
        {/* LP판 크기를 적절하게 조절 */}
        <div className="w-30 h-30 rounded-full bg-own-text border-[8px] border-white shadow-xl flex items-center justify-center animate-spin-slow">
          <div className="w-10 h-10 rounded-full bg-[#e2322f] border-2 border-white" />
        </div>
